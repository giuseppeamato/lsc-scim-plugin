...
class ScimSrcServiceTest {
    ...
    void testSetup() {
        ...
        when(taskType.getPluginSourceService()).thenReturn(pluginSourceService);
    ...
    void constructorWithoutSettingsShouldFail() throws LscServiceException {
        ...
        try {
            testSrcService = new ScimSrcService(taskType);
    ...
    void listPivotShouldReturnEmptyWhenNoResult() throws LscServiceException {
        ...
        ScimSrcService testSrcService = new ScimSrcService(taskType);
        Map<String, LscDatasets> listPivots = testSrcService.getListPivots(task);
    ...
    void listPivotShouldReturnOneUserWhenOneResult() throws LscServiceException {
        ...
        testSrcService = new ScimSrcService(taskType);
        Map<String, LscDatasets> actual = testSrcService.getListPivots(task);
    ...
    void getBeanShouldReturnNullWhenEmptyDataset() throws Exception {
        ...
        when(serviceSettings.getExcludedAttributes()).thenReturn(null);
        ScimSrcService testSrcService = new ScimSrcService(taskType);
        assertThat(testSrcService.getBean(task, "id", new LscDatasets(), FROM_SAME_SERVICE)).isNull();
    }
    ...
    void getBeanShouldReturnNullWhenNoMatchingId() throws Exception {
        ...
        assertThat(testSrcService.getBean(task, "id", nonExistingIdDataset, FROM_SAME_SERVICE)).isNull();
    }
    ...
    void getBeanShouldReturnMainIdentifierSetToIdWhenDefaultPivot() throws Exception {
        ...
        when(serviceSettings.getExcludedAttributes()).thenReturn(null);
        ScimSrcService testSrcService = new ScimSrcService(taskType);
        Map<String, LscDatasets> pivots = testSrcService.getListPivots(task);
        String firstUserPivotValue = pivots.keySet().stream().findFirst().get();
        IBean bean = testSrcService.getBean(task, "id", pivots.get(firstUserPivotValue), FROM_SAME_SERVICE);
    ...
    void getBeanShouldReturnMainIdentifierSetToIdWhenUsernameAsPivot() throws Exception {
        ...
        Map<String, LscDatasets> pivots = testSrcService.getListPivots(task);
        String firstUserPivotValue = pivots.keySet().stream().findFirst().get();
        IBean bean = testSrcService.getBean(task, "userName", pivots.get(firstUserPivotValue), FROM_SAME_SERVICE);
        assertThat(bean.getMainIdentifier()).isEqualTo(pivots.get(firstUserPivotValue).getStringValueAttribute("id"));
    }
    ...
    void getBeanShouldReturnNullWhenNonExistingUserFromAnotherService() throws Exception {
        ...
        IBean bean = testSrcService.getBean(task, "userName", nonExistingIdDataset, !FROM_SAME_SERVICE);
    ...
    void getBeanShouldReturnBeanWithIdWhenFromAnotherService() throws Exception {
        ...
        IBean bean = testSrcService.getBean(task, "userName", datasets, !FROM_SAME_SERVICE);
    ...
    void taskBeanWithoutPublicNoArgContructorShouldFail() throws LscServiceException {
        ...
        IBean bean = null;
        try {
            bean = testSrcService.getBean(task, "id", pivots.get(firstUserPivotValue), FROM_SAME_SERVICE);
    ...
    void getBeanUnauthenticatedShouldFail() throws LscServiceException {
        ...
        try {
            ...
            bean = testSrcService.getBean(task, "id", lscDatasets, FROM_SAME_SERVICE);
        } catch (LscServiceException e) {
            bean = null;
        }
        assertThat(bean).isNull();
    ...
    void listPivotOauth2() throws LscServiceException {
        ...
        try {
            ...
            ScimSrcService testSrcService = new ScimSrcService(taskType);
            listPivots = testSrcService.getListPivots(task);
        } catch (Exception e) {
            e.printStackTrace();
            listPivots = null;
        }
    ...
    void listPivotOauth2WithRefreshToken() throws LscServiceException {
        ...
        try {
            TestSSLUtils.disableSSLVerification();
            ScimSrcService testSrcService = new ScimSrcService(taskType);
            Map<String, LscDatasets> firstListPivots = testSrcService.getListPivots(task);
            ...
            .untilAsserted(() -> {
                ...
                try {
                    secondListPivots = testSrcService.getListPivots(task);
                } catch (Exception e) {
    ...
    void wrongOauth2ConfMustFail() throws LscServiceException {
        ...
        try {
            TestSSLUtils.disableSSLVerification();
            ScimSrcService testSrcService = new ScimSrcService(taskType);
            firstListPivots = testSrcService.getListPivots(task);
        } catch (Exception e) {
            e.printStackTrace();
        }
